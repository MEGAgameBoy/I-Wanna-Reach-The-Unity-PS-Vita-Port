...
public class MenuController : MonoBehaviour
{
    ...
    [SerializeField] uint state2SelectedOption = 0;
    bool lockControls = false;

    //PS Vita Port
    private bool isMovingVerti = false;
    ...
    void Update()
    {
        ...
        switch (menuState)
        {
            ...
            case 1:
                ...
                if (Input.GetAxisRaw("VerticalDpad") < 0 && !lockControls && !isMovingVerti)
                {
                    isMovingVerti = true;
                ...
                if (Input.GetKeyDown(KeyCode.JoystickButton0) && !lockControls)
                {
                    State1ToggleOptions();
                    GameManager.Instance.PlaySound("MenuSelectOption");
                    State1OnOptionPress();
            ...
            case 2:
                ...
                if (Input.GetAxisRaw("HorizontalDpad") < 0 && !lockControls)
                {
                ...
                if (Input.GetKeyDown(KeyCode.JoystickButton1) && !lockControls)
                {
                    GameManager.Instance.PlaySound("MenuSelectOption");
                    State2ToggleOptions();
